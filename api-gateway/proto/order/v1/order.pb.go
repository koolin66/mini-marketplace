...
type Money struct {
	...
	Amount        int64                  `protobuf:"varint,1,opt,name=amount,proto3" json:"amount,omitempty"` // минимальные единицы (центы), как в domain.Money
...
func (x *OrderResponse) GetTotalCost() *Money {
	if x != nil {
		return x.TotalCost
	}
	return nil
...
const file_proto_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/order/v1/order.proto\x12\border.v1\x1a\x1fgoogle/protobuf/timestamp.proto\";\n" +
	"\x05Money\x12\x16\n" +
	...
	"\x05price\x18\x03 \x01(\v2\x0f.order.v1.MoneyR\x05price\x12\x1a\n" +
	...
	"\n" +
	"total_cost\x18\x04 \x01(\v2\x0f.order.v1.MoneyR\ttotalCost\x12\x16\n" +
	...
	"\x06orders\x18\x01 \x03(\v2\x17.order.v1.OrderResponseR\x06orders\x12\x1f\n" +
	...
	"\n" +
	"ListOrders\x12\x1b.order.v1.ListOrdersRequest\x1a\x1c.order.v1.ListOrdersResponseB'Z%order-service/pkg/pb/order/v1;orderv1b\x06proto3"
...
var file_proto_order_v1_order_proto_depIdxs = []int32{
	0,  // 0: order.v1.OrderItem.price:type_name -> order.v1.Money
	1,  // 1: order.v1.CreateOrderRequest.items:type_name -> order.v1.OrderItem
	1,  // 2: order.v1.OrderResponse.items:type_name -> order.v1.OrderItem
	0,  // 3: order.v1.OrderResponse.total_cost:type_name -> order.v1.Money
	7,  // 4: order.v1.OrderResponse.created_at:type_name -> google.protobuf.Timestamp
	7,  // 5: order.v1.OrderResponse.updated_at:type_name -> google.protobuf.Timestamp
	5,  // 6: order.v1.ListOrdersResponse.orders:type_name -> order.v1.OrderResponse
	...
	4,  // 9: order.v1.OrderService.ListOrders:input_type -> order.v1.ListOrdersRequest
